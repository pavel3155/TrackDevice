...
//                        .requestMatchers("/Users/showUsers").hasRole("ADMIN")
//                        .requestMatchers("/Users/regUser").hasRole("ADMIN")
//                        .requestMatchers("/addDevice").hasRole("ADMIN")
//                        .requestMatchers("/editDevice").hasRole("ADMIN")
...
//                        .anyRequest().authenticated())
                        ...
                        .requestMatchers("/img/**").permitAll()
                        .requestMatchers("/js/**").permitAll()
                        .requestMatchers("/Users/editUser").hasRole("ADMIN")
                        .requestMatchers("/Users/regUser").hasRole("ADMIN")
                        .requestMatchers("/addDevice{id}").hasRole("ADMIN")
                        .requestMatchers("/editDevice{id}").hasRole("ADMIN")
                        .anyRequest().authenticated())
                .formLogin(form -> form
                        .loginPage("/login")
                        .defaultSuccessUrl("/")
